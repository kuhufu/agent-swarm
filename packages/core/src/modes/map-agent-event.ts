...
export function mapAgentEvent(e: PiAgentEvent, agentId: string, agentName: string): SwarmEvent | null {
  switch (e.type) {
    ...
    case "tool_execution_start":
      return { type: "tool_execution_start", agentId, toolName: e.toolName, toolCallId: e.toolCallId, args: e.args };
    case "tool_execution_update":
      return { type: "tool_execution_update", agentId, toolName: e.toolName, toolCallId: e.toolCallId, args: e.args, partialResult: e.partialResult };
    case "tool_execution_end":
      return { type: "tool_execution_end", agentId, toolName: e.toolName, toolCallId: e.toolCallId, result: e.result, isError: e.isError };
    default: return null;
  }
}
